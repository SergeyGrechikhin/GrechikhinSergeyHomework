...
public class OrderDemo {
    public static void main(String[] args) {
        ...
        orders.add(new Order("Товар 2","В обработке",1,"20.07.25",115,"Одежда"));
        orders.add(new Order("Товар 3","Отправлен",1,"20.07.25",110,"Запчасти"));
        orders.add(new Order("Товар 4","В обработке",1,"20.07.25",120,"Игрушки"));
        orders.add(new Order("Товар 5","Получен",1,"13.06.25",150,"Книги"));
